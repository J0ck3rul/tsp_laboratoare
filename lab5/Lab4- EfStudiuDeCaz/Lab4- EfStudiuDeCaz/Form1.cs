...
namespace Lab4__EfStudiuDeCaz
{
    public partial class Form1 : Form
    {
        ...
        {
            var cl = new ModelSelfRefrences.SelfReferenceAssertMethods();
            var model = new ModelSelfRefrences.SelfReference();
            model.Name = "asd";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                var product = new ModelProduct.Product
                {
                ...
                product = new ModelProduct.Product { Description = "Rugged Ranger Duffel Bag", Price = 39.97M, ImageURL = "/pack178.jpg" };
                context.Products.Add(product);
                product = new ModelProduct.Product { Description = "Range Field Pack", Price = 98.97M, ImageURL = "/noimage.jp" };
                context.Products.Add(product);
                product = new ModelProduct.Product { Description = "Small Deployment Back Pack", Price = 29.97M, ImageURL = "/pack202.jpg" };
                context.Products.Add(product);
                context.SaveChanges();
            }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            using (var context = new ModelEmployee())
            {
                ...
                foreach (var hourly in context.Employees.OfType<HourlyEmployee>()) { Console.WriteLine("{0} {1}", hourly.FirstName, hourly.LastName); }
            }
        }
    }
}
