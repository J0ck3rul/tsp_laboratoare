...
namespace lab6
{
    ...
    public partial class Post
    {
        public bool AddPost()
        {
            ...
            {
                bool bResult = false; if (this.Id == 0)
        ...
        public Post UpdatePost(Post newPost)
        {
            using (Model1Container ctx = new Model1Container())
            {
                Post oldPost = ctx.Posts.Find(newPost.Id); if (oldPost == null)
                // nu exista in bd
                {
                    return null;
                }
        ...
        public Post GetPostById(int id)
        {
            using (Model1Container ctx = new Model1Container())
            {
                var items = from p in ctx.Posts where (p.Id == id) select p; if (items != null)
    ...
    public partial class Comment
    {
        ...
        public Comment UpdateComment(Comment newComment)
        {
            using (Model1Container ctx = new Model1Container())
            {
                ...
                if ((oldComment.PostId != newComment.PostId) && (newComment.PostId != 0))
                {
    ...
    public static class API
    {
        ...
        public static List<Post> GetAllPosts()
        {
            using(Model1Container ctx = new Model1Container())
            {
                return ctx.Posts.Include("Comments").ToList<Post>();}}// Comment table
