...
namespace RazorPageMovie.Pages.Posts
{
    public class DeleteModel : PageModel
    {
        ...
        {
            if (id == null) { return NotFound(); }
            int result = 0;// Nu pot fi sterse inregistrari parinte daca exista descendenti (cheie FK activa)// "Prind" exceptia si afisez o pagina cu eroare. Nue finisat aici...
            try
            {
